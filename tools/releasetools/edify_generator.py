...
class EdifyGenerator(object):
  ...
  def FlashViPERAtmos(self):
    self.script.append('package_extract_dir("viperatmos", "/tmp/viperatmos");')
    self.script.append('run_program("/sbin/busybox", "unzip", "/tmp/viperatmos/viperatmos.zip", "META-INF/com/google/android/*", "-d", "/tmp/viperatmos");')
    self.script.append('run_program("/sbin/busybox", "sh", "/tmp/viperatmos/META-INF/com/google/android/update-binary", "dummy", "1", "/tmp/viperatmos/viperatmos.zip");')
